...
import MonthlyCalendarPickerView, {
  dailyOpeningToCalendarDisplay
} from './MonthlyCalendarPickerView';
...
describe('MonthlyCalendarPickerView', () => {
    ...
    it('renders', () => {
      render(
        withHistoryConfiguration(
          withIntlConfiguration(<MonthlyCalendarPickerView />)
        )
      );
  ...
  describe('renders a MonthlyCalendarPickerView', () => {
    ...
    it('should render 5 nav items', () => {
      ...
      expect(links[3].textContent).toEqual(
...
test('dailyOpeningToCalendarDisplay', () => {
  ...
  expect(dailyOpeningToCalendarDisplay(useIntl, openingInfo).key).toBe(
    '975628800000'
  );
});
