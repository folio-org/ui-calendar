...
test("isSameMonthOrBefore works as expected", () => {
  ...
  expect(isSameMonthOrBefore(Dates.MAY_14_DATE, Dates.MAY_14_2001_DATE)).toBe(true);
  expect(isSameMonthOrBefore(Dates.JUL_1_DATE, Dates.MAY_14_2001_DATE)).toBe(true);
  ...
  expect(isSameMonthOrBefore(Dates.MAY_14_2001_DATE, Dates.MAY_14_DATE)).toBe(false);
  expect(isSameMonthOrBefore(Dates.MAY_14_2001_DATE, Dates.JUL_1_DATE)).toBe(false);
